...
public class AccessPointDeviceDiscoverCorrectlyTest {

    NetworkUtil networkUtil;

    public AccessPointDeviceDiscoverCorrectlyTest() {
        networkUtil = NetworkUtil.getInstance(DeviceType.ACCESS_POINT);
    }
