...
public class AccessPointResDeviceDiscoverCorrectlyTest {

    NetworkUtil networkUtil;

    public AccessPointResDeviceDiscoverCorrectlyTest() {
        networkUtil = NetworkUtil.getInstance(DeviceType.ACCESS_POINT_WRES);
    }
