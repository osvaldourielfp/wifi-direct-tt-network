...
public class RangeExtenderReqDeviceDiscoverCorrectlyTest {

    NetworkUtil networkUtil;

    public RangeExtenderReqDeviceDiscoverCorrectlyTest() {
        networkUtil = NetworkUtil.getInstance(DeviceType.RANGE_EXTENDER_WREQ);
    }
