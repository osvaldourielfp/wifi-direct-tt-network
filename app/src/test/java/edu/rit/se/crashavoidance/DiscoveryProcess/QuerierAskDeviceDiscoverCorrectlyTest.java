...
public class QuerierAskDeviceDiscoverCorrectlyTest {

    NetworkUtil networkUtil;

    public QuerierAskDeviceDiscoverCorrectlyTest() {
        networkUtil = NetworkUtil.getInstance(DeviceType.QUERIER_ASK);
    }
