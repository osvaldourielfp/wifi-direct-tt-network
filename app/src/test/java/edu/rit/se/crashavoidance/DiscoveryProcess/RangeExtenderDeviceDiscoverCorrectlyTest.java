...
public class RangeExtenderDeviceDiscoverCorrectlyTest {

    NetworkUtil networkUtil;

    public RangeExtenderDeviceDiscoverCorrectlyTest() {
        networkUtil = NetworkUtil.getInstance(DeviceType.RANGE_EXTENDER);
    }
